...
function calculateFinalScore(learnerResults, classroomManagement, teachingQuality, administration, professionalConduct) {
    const sum = learnerResults +
        classroomManagement +
        teachingQuality +
        administration +
        professionalConduct;
...
router.post("/", async (req, res) => {
    try {
        ...
        if ([learnerResults, classroomManagement, teachingQuality, administration, professionalConduct].some((v) => Number.isNaN(v))) {
        ...
        const finalScore = calculateFinalScore(learnerResults, classroomManagement, teachingQuality, administration, professionalConduct);
