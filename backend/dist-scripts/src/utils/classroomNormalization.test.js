...
const classroomNormalization_1 = require("./classroomNormalization");
function norm(raw, gradeHint, options) {
    return (0, classroomNormalization_1.normalizeClassroomInput)(raw, gradeHint, options);
}
const cases = [
...
for (const c of cases) {
    ...
    const ok = r.classroomName === c.classroomName &&
...
const groups = (0, classroomNormalization_1.groupClassroomsByMatchKey)([
    { raw: "Grade 1A 2026" },
    { raw: "GRADE 1 A 2026" },
]);
if (groups.size !== 1) {
