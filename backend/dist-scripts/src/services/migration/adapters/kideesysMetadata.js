...
exports.KIDEESYS_ADAPTER_METADATA = exports.KIDEESYS_KNOWN_ALIASES = exports.KIDEESYS_CONFIDENCE_RULES = exports.KIDEESYS_SUPPORTED_CATEGORIES = exports.KIDEESYS_SUPPORTED_FILES = exports.KIDEESYS_SUPPORTED_EXPORTS = exports.KIDEESYS_ADAPTER_VERSION = void 0;
/** Read-only Kid-e-Sys Adapter v1 metadata — no registry or live import side effects. */
exports.KIDEESYS_ADAPTER_VERSION = "1";
exports.KIDEESYS_SUPPORTED_EXPORTS = [
    {
...
exports.KIDEESYS_SUPPORTED_FILES = [
    "Account List",
    "Transaction List",
    "Contact List",
    "Billing Plan",
...
exports.KIDEESYS_SUPPORTED_CATEGORIES = [
    "learners",
    "parents",
    "billing",
    "transactions",
...
exports.KIDEESYS_CONFIDENCE_RULES = {
...
exports.KIDEESYS_KNOWN_ALIASES = {
...
exports.KIDEESYS_ADAPTER_METADATA = {
    adapterId: "kideesys-adapter-v1",
    version: exports.KIDEESYS_ADAPTER_VERSION,
    source: "kideesys",
    capabilities: {
        detection: true,
        normalization: true,
    ...
    supportedFiles: [...exports.KIDEESYS_SUPPORTED_FILES],
    supportedCategories: [...exports.KIDEESYS_SUPPORTED_CATEGORIES],
    supportedExports: [...exports.KIDEESYS_SUPPORTED_EXPORTS],
    confidenceRules: { ...exports.KIDEESYS_CONFIDENCE_RULES },
    knownAliases: { ...exports.KIDEESYS_KNOWN_ALIASES },
};
