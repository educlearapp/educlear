...
const ensureEduClearPackages_1 = require("../src/services/ensureEduClearPackages");
const payfastService_1 = require("../src/services/payfastService");
...
async function main() {
    ...
    if (schoolId !== DA_SILVA_SCHOOL_ID) {
        throw new Error(`Refusing: this script only activates Da Silva Academy (${DA_SILVA_SCHOOL_ID}), got ${schoolId}`);
    }
