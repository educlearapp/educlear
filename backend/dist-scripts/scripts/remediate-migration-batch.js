...
const rollbackMigrationBatch_1 = require("../src/services/migration/core/rollbackMigrationBatch");
async function main() {
    ...
    const targetSchoolId = String(process.argv[3] || "").trim() || batch.targetSchoolId;
    ...
    console.log(`Created in batch: learners=${batch.createdCounts?.learners ?? 0}, ` +
