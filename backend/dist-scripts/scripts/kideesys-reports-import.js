...
const kideesysReportsBillingImport_1 = require("../src/services/kideesysReportsBillingImport");
...
async function main() {
    ...
    const result = await (0, kideesysReportsBillingImport_1.kideesysReportsImportAndAudit)({
        schoolId,
        paths: {
            ageAnalysisXls: age,
