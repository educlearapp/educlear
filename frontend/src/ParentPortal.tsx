...
const ParentPortal: React.FC<ParentPortalProps> = ({
  ...
  async function loadThread(opts?: { category?: MessageCategory; learnerId?: string }) {
    ...
    try {
      ...
      const data = (await apiFetch(`/api/parent-portal/thread?${qs.toString()}`)) as any;
  ...
  async function sendMessage() {
    ...
    try {
      ...
      await apiFetch("/api/parent-portal/send-message", {
  ...
  async function onLookup() {
    ...
    try {
      ...
      const lookupRes = await fetch(`${API_BASE}/parent-portal/lookup?${qs.toString()}`);
      ...
      if (!lookupRes.ok) {
        ...
        throw new Error(data?.error || data?.message || "Parent portal lookup failed");
      ...
      const statementRes = await fetch(
        ...
        `${API_BASE}/statements/accounts?schoolId=${encodeURIComponent(schoolId)}`
      ...
      const statementData = (await statementRes.json()) as {
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "flex-start" }}>
                  ...
                  <button onClick={onGoToStatements} style={portalButtonStyle}>
                  ...
                  <button onClick={onGoToInvoices} style={portalButtonStyle}>
                  ...
                  <button onClick={onGoToIncidents} style={portalButtonStyle}>
                  ...
                  learners.map((x) => (
                    ...
                    >
                        ...
                        {accountForLearner(x.learner) ? (
                          ...
                          <div style={{ marginTop: 6, fontWeight: 900, color: "#0f172a" }}>
                            ...
                            <span style={{ color: GOLD }}>
                              ...
                              {Number(accountForLearner(x.learner)?.balance || 0).toLocaleString("en-ZA", {
                      ...
                      <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                        ...
                        <button onClick={() => onOpenLearnerProfile(x.learner)} style={portalButtonStyle}>
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: 10, flexWrap: "wrap" }}>
              ...
              <button onClick={() => setMessageOpen(false)} style={portalButtonStyle}>
