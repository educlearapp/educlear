  ...
  return (
    <main className="teacher-app-main" style={{ maxWidth: 480 }}>
      ...
      <p className="teacher-muted" style={{ marginBottom: 24 }}>
        ...
        <strong>STAFF</strong> role or school admins can use this iPad-friendly app.
      </p>
      ...
      <p className="teacher-pwa-hint">
        <strong>Add to Home Screen:</strong> in Safari, tap Share → Add to Home Screen to open EduClear Teacher like
        an app. Install prompts may vary by browser.
      </p>
