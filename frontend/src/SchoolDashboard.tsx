...
>
  ...
  <button type="button" onClick={() => go("dashboard")} className="profile-action-btn">
  ...
  <button type="button" onClick={() => alert("Profile saved")} className="profile-action-btn">
  ...
  <div className="profile-more-wrap">
    ...
    <button
      ...
      onClick={() => setProfileMoreOpen(!profileMoreOpen)}
...
<div className="profile-more-menu" onClick={(e) => e.stopPropagation()}>
        ...
        <button type="button">Change Package</button>



        <button type="button">Print Profile</button>



        <button type="button" className="danger">Close Account</button>
      ...
      <div className="profile-card">
        ...
        <div className="profile-main">
          ...
          <button type="button" onClick={() => setProfileTab("general")} className={`tab ${profileTab === "general" ? "active" : ""}`}>General</button>

          <button type="button" onClick={() => setProfileTab("contact")} className={`tab ${profileTab === "contact" ? "active" : ""}`}>Contact</button>



<button type="button" onClick={() => setProfileTab("address")} className={`tab ${profileTab === "address" ? "active" : ""}`}>Address</button>



<button type="button" onClick={() => setProfileTab("billing")} className={`tab ${profileTab === "billing" ? "active" : ""}`}>Billing</button>



<button type="button" onClick={() => setProfileTab("password")} className={`tab ${profileTab === "password" ? "active" : ""}`}>Password</button>
          ...
          <div className="profile-form">
            ...
            <div className="form-row">
              ...
              <input value="dasilvaacademy@gmail.com" />
