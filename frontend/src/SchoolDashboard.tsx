        ...
        case "more":
         ...
         case "plans": {
          ...
          const loadFeesThenOpen = async () => {
            ...
            const stateFees = possibleStateLists.find(
            ...
            if (stateFees) {
              ...
              loadedFees = stateFees.map(normalizeFee);
            ...
            if (loadedFees.length === 0) {
              ...
              const endpoints = [
                ...
                `${API_URL}/api/fees/${schoolIdForPlans}`,
        
        
        
                `${API_URL}/api/fees?schoolId=${schoolIdForPlans}`,
                ...
                `${API_URL}/api/billing/fees/${schoolIdForPlans}`,
        
        
        
                `${API_URL}/api/billing/fees?schoolId=${schoolIdForPlans}`,
                    ...
                    <div style={{ background: "#fff", borderRadius: "16px", overflow: "hidden", border: "1px solid #e2e8f0" }}>
                      ...
                      <div style={{ padding: "14px" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "12px" }}>
                          ...
                          <strong>{getName(selectedPlanLearner)} {getSurname(selectedPlanLearner)}</strong>
...
<tfoot>
  ...
  <tr>
    ...
    <td style={td}><strong>{money(total)}</strong></td>
...
<button
  ...
  onClick={() => {
    ...
    const selectedFees = feeOptions.filter((fee: any) => {
      ...
      const box = document.getElementById(`fee-check-${fee.id}`) as HTMLInputElement | null;
    ...
    savePlan(selectedPlanLearner, [
      ...
      ...selectedFees.map((fee: any) => ({ ...fee, dueDate: "" })),
...
return (
  ...
  >
    ...
    <td style={{ ...td, color: "#15803d", fontWeight: 800 }}>
