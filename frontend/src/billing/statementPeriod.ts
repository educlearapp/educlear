...
import { isKidesysOpeningBalanceEntry, shouldShowLedgerEntryOnStatement } from "./billingDisplayRules";
...
/** Normalises period query/state; empty or unknown values default to All Time. */
...
/** Cutoff date for rolling month windows; null means no cutoff (All Time). */
...
/** Filename slug, e.g. 3months, 6months, alltime. */
...
/** Opening Balance Migration: All Time, or entry date within the selected window. */
...
/** Ledger balance from transactions strictly before the selected period cutoff. */
