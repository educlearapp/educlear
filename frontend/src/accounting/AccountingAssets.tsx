...
function buildSampleAssets(): AssetRecord[] {
  const now = new Date().toISOString();
  const samples: Array<Omit<AssetRecord, "id" | "createdAt" | "updatedAt" | "depreciationYearsApplied">> = [
    {
      ...
      usefulLifeYears: 50,
      currentBookValue: 3825000,
      location: "Campus — Block A",
      assignedTo: "Facilities",
      supplier: "BuildRight Contractors",
      warrantyExpiry: "",
      notes: "Main teaching block including admin wing",
      status: "Active",
      disposalDate: "",
      disposalAmount: 0,
      disposalReason: "",
    ...
    },
    {
      name: "School Bus 1",
      category: "Buses",
      assetNumber: "AST-BUS-001",
      serialNumber: "MBZ-2021-88421",
      purchaseDate: "2021-06-01",
      purchaseCost: 980000,
      depreciationMethod: "Straight Line",
      usefulLifeYears: 10,
      currentBookValue: 686000,
      location: "Transport Yard",
      assignedTo: "Transport Department",
      supplier: "Mercedes-Benz SA",
      warrantyExpiry: "2024-06-01",
      notes: "32-seater scholar transport",
      status: "Active",
      disposalDate: "",
      disposalAmount: 0,
      disposalReason: "",
    ...
    {
      name: "iPad Grade 4 Set",
      category: "iPads / Tablets",
      assetNumber: "AST-IPD-004",
      serialNumber: "SET-IPAD-G4-24",
      purchaseDate: "2024-01-20",
      purchaseCost: 185000,
      depreciationMethod: "Straight Line",
      usefulLifeYears: 4,
      currentBookValue: 138750,
      location: "Grade 4 Classroom Block",
      assignedTo: "Grade 4 Teachers",
      supplier: "iStore Education",
      warrantyExpiry: "2026-01-20",
      notes: "24 devices + charging trolley",
      status: "Active",
      disposalDate: "",
      disposalAmount: 0,
      disposalReason: "",
    ...
    },
    {
      ...
      category: "Computers",
      assetNumber: "AST-PC-ADM",
      serialNumber: "DELL-LAT-ADM-12",
      purchaseDate: "2023-03-10",
      purchaseCost: 96000,
      depreciationMethod: "Straight Line",
      usefulLifeYears: 5,
      currentBookValue: 67200,
      location: "Admin Office",
      assignedTo: "School Secretary",
      supplier: "Dell South Africa",
      warrantyExpiry: "2026-03-10",
      notes: "12 laptops for admin staff",
      status: "Active",
      disposalDate: "",
      disposalAmount: 0,
      disposalReason: "",
    ...
    },
    {
      ...
      location: "Classrooms 101–108",
      assignedTo: "Foundation Phase",
      supplier: "Office Furniture SA",
      warrantyExpiry: "",
      notes: "120 learner desks",
      status: "Active",
      disposalDate: "",
      disposalAmount: 0,
      disposalReason: "",
    ...
    },
    {
      ...
      category: "Chairs",
      assetNumber: "AST-CHR-101",
      serialNumber: "",
      purchaseDate: "2022-11-01",
      purchaseCost: 28000,
      depreciationMethod: "Straight Line",
      usefulLifeYears: 8,
      currentBookValue: 22400,
      location: "Classrooms 101–108",
      assignedTo: "Foundation Phase",
      supplier: "Office Furniture SA",
      warrantyExpiry: "",
      notes: "120 stackable chairs",
      status: "Active",
      disposalDate: "",
      disposalAmount: 0,
      disposalReason: "",
    ...
    },
    {
      name: "Projector Hall",
      category: "Projectors",
      assetNumber: "AST-PRJ-HALL",
      serialNumber: "EPSON-EB-2250U",
      purchaseDate: "2023-08-15",
      purchaseCost: 28500,
      depreciationMethod: "Straight Line",
      usefulLifeYears: 6,
      currentBookValue: 21375,
      location: "School Hall",
      assignedTo: "Events / Assemblies",
      supplier: "Epson SA",
      warrantyExpiry: "2025-08-15",
      notes: "Ceiling-mounted hall projector",
      status: "Active",
      disposalDate: "",
      disposalAmount: 0,
      disposalReason: "",
  ...
  return samples.map((s) => {
    const row: AssetRecord = {
      ...s,
      id: uid(),
      depreciationYearsApplied: [],
      createdAt: now,
      updatedAt: now,
    };
    const dep = computeAssetDepreciation(row);
    return { ...row, currentBookValue: dep.bookValue };
  });
}
