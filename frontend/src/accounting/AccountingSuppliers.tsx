...
function buildSampleSuppliers(): SupplierRecord[] {
  const now = new Date().toISOString();
  const samples: Array<Omit<SupplierRecord, "id" | "createdAt" | "updatedAt">> = [
    {
      name: "Eskom",
      category: "Utilities",
      contactPerson: "Accounts Payable",
      email: "billing@eskom.co.za",
      phone: "086 003 7566",
      vatNumber: "4500106771",
      registrationNumber: "",
      bankName: "FNB",
      accountNumber: "62000000001",
      branchCode: "250655",
      paymentTerms: "30 days",
      notes: "Electricity supply — municipal account",
      status: "Active",
      recurring: true,
      autoMatchRule: "Contains ESKOM",
      spend: {
        thisMonth: 18420.5,
        lastMonth: 17280,
        yearToDate: 89420,
        ...
        averageMonthlySpend: 17850,
      },
    },
    {
      name: "Standard Bank",
      category: "Professional Services",
      contactPerson: "Business Banking",
      email: "school.banking@standardbank.co.za",
      phone: "086 012 0000",
      vatNumber: "4110102054",
      registrationNumber: "",
      bankName: "Standard Bank",
      accountNumber: "—",
      branchCode: "051001",
      paymentTerms: "Monthly",
      notes: "Bank charges and merchant fees",
      status: "Active",
      recurring: true,
      autoMatchRule: "Contains STANDARD BANK",
      spend: {
        thisMonth: 2840,
        lastMonth: 2650,
        yearToDate: 14200,
    ...
    },
    {
      ...
      email: "fleet@shell.co.za",
      phone: "0800 600 664",
      vatNumber: "4940102587",
      registrationNumber: "",
      bankName: "ABSA",
      accountNumber: "4050001234",
      branchCode: "632005",
      paymentTerms: "14 days",
      notes: "School bus and staff travel fuel",
      status: "Active",
      recurring: true,
      autoMatchRule: "Contains SHELL",
      spend: {
        thisMonth: 12650,
        lastMonth: 11890,
        yearToDate: 58200,
        ...
        averageMonthlySpend: 12100,
      },
    },
    {
      name: "Makro",
      category: "Stationery",
      contactPerson: "Business Account Desk",
      email: "b2b@makro.co.za",
      phone: "086 000 6227",
      vatNumber: "4940102587",
      registrationNumber: "",
      bankName: "Nedbank",
      ...
      branchCode: "198765",
      paymentTerms: "30 days",
      notes: "Classroom stationery bulk orders",
      status: "Active",
      recurring: false,
      autoMatchRule: "Contains MAKRO",
      spend: {
        thisMonth: 4820,
        lastMonth: 3150,
        yearToDate: 22400,
    ...
    },
    {
      ...
      email: "accounts@secureguard.co.za",
      phone: "011 555 0199",
      vatNumber: "",
      registrationNumber: "2018/112233/07",
      bankName: "Capitec Business",
      accountNumber: "1410009988",
      branchCode: "470010",
      paymentTerms: "7 days",
      notes: "After-hours security patrol contract",
      status: "Active",
      recurring: true,
      autoMatchRule: "Contains SECUREGUARD",
      spend: {
        thisMonth: 28500,
        lastMonth: 28500,
        yearToDate: 142500,
...
export default function AccountingSuppliers({ schoolId = "" }: Props) {
  ...
  useEffect(() => {
    ...
    setSuppliers(stored?.length ? stored : buildSampleSuppliers());
